...
test('recordingFromRow: snake→camel, 전사 마커는 없으면 null', () => {
  assert.deepEqual(
    recordingFromRow({ session_id: 'x', seq: 2, start_ms: 100, dur_ms: 5000, path: 'u/x/2.m4a' }),
    { seq: 2, startMs: 100, durMs: 5000, path: 'u/x/2.m4a', transcribedAt: null });
  assert.equal(
    recordingFromRow({ seq: 1, start_ms: 0, dur_ms: 1, path: 'p', transcribed_at: '2026-07-21T00:00:00Z' }).transcribedAt,
